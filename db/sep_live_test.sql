...
--
-- Host: localhost
-- Generation Time: May 02, 2023 at 04:07 AM
...
CREATE TABLE `bookables` (
  ...
  `bookable_name` varchar(40) NOT NULL,
  `bookable_price` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(219, 2, 7, '2023-05-09 15:30:00', 16),
(223, 1, 7, '2023-05-03 15:30:00', 15),
(226, 3, 7, '2023-05-09 15:30:00', 16);
...
(12, 7, '2023-05-02 15:30:00', '2023-05-02 16:30:00', 2),
(13, 6, '2023-04-27 11:00:00', '2023-04-27 12:00:00', 24),
(14, 9, '2023-04-27 15:30:00', '2023-04-27 16:30:00', 89),
(15, 7, '2023-05-03 15:30:00', '2023-05-03 16:30:00', 2),
(16, 7, '2023-05-09 15:30:00', '2023-05-09 16:30:00', 4),
(17, 10, '2023-05-03 09:30:00', '2023-05-03 10:30:00', 2);
...
--
ALTER TABLE `bookables`
  MODIFY `bookable_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bookings`
--
ALTER TABLE `bookings`
  MODIFY `booking_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
...
--
ALTER TABLE `sessions`
  MODIFY `session_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `bookables`
  ADD CONSTRAINT `bookables_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`);
